...
def db_create():
    ...
    Course1 = Course.create(
        id=1, name="python", time_start=date(2021, 7, 21), time_end=date(2021, 8, 21)
    )
    Course2 = Course.create(
        id=2, name="java", time_start=date(2021, 7, 13), time_end=date(2021, 8, 16)
    )
...
def db_query():
    ...
    print("Request 2:")
    query2 = (
        Student.select(Student, Student_course, Course)
        .join(Student_course)
        .join(Course)
